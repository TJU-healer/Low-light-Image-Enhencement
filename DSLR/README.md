...
\begin{aligned}
&x_1 = input(img)\\
&x_2 = f_{\downarrow}(x_1)\\
&x_3 = f_{\downarrow}(x_2)\\
&\Phi_3 = x_3\\
&\Phi_2 = x_2 - f_{\uparrow}(x_3)\\
&\Phi_1 = x_1 - f_{\uparrow}(x_2)\\
&\widetilde{\Phi}_1 = resblock1(\Phi_1)\\
&\widetilde{\Phi}_2 = resblock2(\Phi_2)\\
&\widetilde{\Phi}_3 = resblock3(\Phi_3)\\
&\widetilde{x}_3 = \widetilde{\Phi}_3\\
&\widetilde{x}_2 = \widetilde{\Phi}_2 + f_{\uparrow}(\widetilde{x}_3)\\
&\widetilde{x}_1 = \widetilde{\Phi}_1 + f_{\uparrow}(\widetilde{x}_2)
\end{aligned}
$$
