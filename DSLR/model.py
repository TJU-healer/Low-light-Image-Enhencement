...
class LMSB(nn.Module):
    def __init__(self):
        ...
        self.conv1_1 = nn.Conv2d(3, NDF * 1, 5, 2, 2)  # 3->64
        self.conv2_1 = nn.Conv2d(NDF * 1, NDF * 2, 5, 2, 2)  # 64->128
        self.conv3_1 = nn.Conv2d(NDF * 2, NDF * 4, 5, 2, 2)  # 128->256
        ...
        self.Deconv1_1 = nn.ConvTranspose2d(NDF * 4, NDF * 2, 4, 2, 1)  # 256->128
        self.Deconv2_1 = nn.ConvTranspose2d(NDF * 2, NDF * 1, 4, 2, 1)  # 128->64
    ...
    def forward(self, x):
        ...
        x = F.relu(self.IN_conv3(self.conv3_1(x2)))
        x = self.conv3_r1(x)

        x = self.Deconv1_r1(x)

        x = F.relu(self.IN_conv2(self.Deconv1_1(x)))

        x = self.Deconv2_r1(x+x2)
        x = F.relu(self.IN_conv1(self.Deconv2_1(x)))
...
class LMSB_2(nn.Module):
    def __init__(self):
        ...
        self.conv1_r1 = lrBLock_l2(NDF2 * 1,3)  # 32->32
        self.conv2_r1 = lrBLock_l2(NDF2 * 2,3)  # 64->64
        self.conv3_r1 = lrBLock_l2(NDF2 * 4,3)  # 128->128
        ...
        self.Deconv3_r1 = lrBLock_l2(NDF2 * 1,3)  # 32->32
        self.Deconv2_r1 = lrBLock_l2(NDF2 * 2,3)  # 64->64
        self.Deconv1_r1 = lrBLock_l2(NDF2 * 4,3)  # 128->128
...
class LMSN(nn.Module):
    def __init__(self):
        ...
        self.Stage1 = LMSB() # Net3
        self.Stage2 = LMSB_2() # Net2
        self.Stage3 = LMSB_2() # Net1
